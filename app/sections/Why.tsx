...
export default function Why() {
  ...
  return (
    <SectionReveal>
      <section
        id="why"
        className="py-20 sm:py-24 md:py-28 lg:py-32 bg-[#FAFAF9] text-[#1F2937]"
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          ...
          <FadeUp>
            <p className="text-base sm:text-lg md:text-xl text-gray-700 max-w-3xl mx-auto mb-12 sm:mb-14 md:mb-16">
              Family-owned, Maryland-based, and committed to excellent work and
              honest service. We deliver thoughtful design, reliable timelines,
              ...
              {reasons.map((r) => (
                <FadeUp key={r.title}>
                  <div className="p-5 sm:p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow text-left">
                    ...
                    <h3 className="text-lg sm:text-xl font-semibold text-[#2E7D32] mb-1.5">
                      {r.title}
                    </h3>
